use crate::components::{RssConfig, RssState};
use bevy_ecs::prelude::*;
use ferroflux_types::{
    BlobStore, GlobalHttpClient, NodeConfig, Outbox, SystemEvent, SystemEventBus,
};
use serde_json::json;
...
pub fn rss_worker(
    ...
    if let Some(last) = *local && last.elapsed() < std::time::Duration::from_secs(10) {
        return;
    }
